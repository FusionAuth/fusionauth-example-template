...
When in doubt, you can use [https://fusionauth.io/docs/quickstarts/quickstart-springboot-web](https://fusionauth.io/docs/quickstarts/quickstart-springboot-web) as an example.
